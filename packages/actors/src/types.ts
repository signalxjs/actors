 ...
 * there leaves the state dirty and it rides the next flush, while an etag
 * conflict faults the activation (`ActorStateConflictError`) and its
...
> {
     ...
     * `StateErrorPhase` for what each phase means for the state. Runs
