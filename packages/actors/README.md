...
Peer dependencies, all on core's **1.0** line (`^1.0.1`) — required:
`@sigx/serialize`, `@sigx/server` and `@sigx/reactivity`. Optional: `@sigx/runtime-core` (the `./app` integration), plus
